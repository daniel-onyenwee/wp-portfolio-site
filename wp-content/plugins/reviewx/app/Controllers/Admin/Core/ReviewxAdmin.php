        ...
        public function rx_export_review() {
            ...
            if( $product_name == 'all' ){
                ...
                $sql_query = $wpdb->prepare(
                    ...
                    ",
                 $review_type, $review_status, $start_date, $end_date,$review_sort,$review_sort_by,$skip_export_row,$export_limit
                    );
            } else {
                $review_type = 'review';
                $sql_query = $wpdb->prepare(
                    "SELECT * FROM `$comments` AS comments
                        ...
                        WHERE (comments.comment_type = %s AND comments.comment_parent = 0
                            ...
                            ORDER BY %s %s LIMIT %d, %d
                        ",
                    $review_type, $review_status, $start_date, $end_date, $product_name,$review_sort,$review_sort_by,$skip_export_row,$export_limit
                     );
            }
